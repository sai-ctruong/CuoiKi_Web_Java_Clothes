...
public class Cart implements Serializable {
    ...
    public void removeItem(int productId) {
        items.removeIf(item -> item.getProduct() != null && item.getProduct().getId() == productId);
    }
    ...
    public SessionCartItem findItemByProductId(int productId) {
        return items.stream()
                .filter(item -> item.getProduct() != null && item.getProduct().getId() == productId)
                .findFirst()
                .orElse(null);
    }
