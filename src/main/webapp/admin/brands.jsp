...
<body>
        ...
        <div class="admin-main">
            <header class="admin-header">
                <div class="header-left">
                    ...
                    <h4 class="page-title mb-0">Quản lý Thương hiệu</h4>
                </div>
                <div class="header-right">
                    <a href="${pageContext.request.contextPath}/manage/brands?action=add" class="btn btn-primary">
            ...
            <main class="admin-content">
                ...
                <div class="data-table">
                    <div class="data-table-header">
                        <h5><i class="bi bi-award me-2"></i>Danh sách thương hiệu (${brands.size()})</h5>
                    </div>
                                        ...
                                        <tr>
                                            <td colspan="5">
                                                <div class="empty-state">
                                                    ...
                                                    <a href="${pageContext.request.contextPath}/manage/brands?action=add" class="btn btn-primary">
                                                        <i class="bi bi-plus-lg me-2"></i>Thêm thương hiệu đầu tiên
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-muted">
                                                    <c:if test="${not empty brand.origin}">
                                                        <i class="bi bi-geo-alt me-1"></i>${brand.origin}
                                                    </c:if>
                                                    <c:if test="${empty brand.origin}">-</c:if>
                                                </td>
                                                <td>
                                                    <span class="badge bg-secondary">${brand.productCount} sản phẩm</span>
                                                </td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/manage/brands?action=edit&id=${brand.id}" 
                                                       class="btn btn-action btn-edit" title="Sửa">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-action btn-delete" 
                                                            onclick="confirmDelete(${brand.id}, '${brand.name}', ${brand.productCount})" title="Xóa">
        ...
        <div class="modal-dialog">
            <div class="modal-content" style="background: var(--admin-card-bg); border: 1px solid var(--admin-border);">
                ...
                <div class="modal-body">
                    <p>Bạn có chắc chắn muốn xóa thương hiệu "<span id="deleteName"></span>"?</p>
    ...
    <script>
        function confirmDelete(id, name, productCount) {
            ...
            document.getElementById('deleteConfirmBtn').href = '${pageContext.request.contextPath}/manage/brands?action=delete&id=' + id;
            
            var warning = document.getElementById('warningMessage');
            if (productCount > 0) {
                warning.innerHTML = '<i class="bi bi-exclamation-circle me-1"></i>Thương hiệu này đang có ' + productCount + ' sản phẩm. Không thể xóa!';
