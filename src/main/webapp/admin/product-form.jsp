                    ...
                    <form action="${pageContext.request.contextPath}/manage/products" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-section">
                                    <div class="form-section-title">
                                        <i class="bi bi-tag"></i> Chi tiết sản phẩm
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                    ...
                                    <div class="image-section-container">
                                        ...
                                        <div class="image-section-info">
                                            <small class="text-muted">
                                                <i class="bi bi-info-circle me-1"></i>Kích thước: 500x500px
                                            </small>
                                            <button type="button" class="btn btn-outline-secondary btn-sm change-image-btn" onclick="document.getElementById('image').click()">
