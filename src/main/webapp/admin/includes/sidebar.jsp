...
<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="nav flex-column">
            ...
            <!-- QUẢN LÝ SẢN PHẨM - Chỉ ADMIN mới thấy -->
            ...
            <!-- QUẢN LÝ ĐƠN HÀNG - Admin và Staff đều thấy -->
