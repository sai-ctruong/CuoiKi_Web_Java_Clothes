...
<body>
    ...
    <c:if test="${not empty sessionScope.successMessage}">
        <section class="alert alert-success alert-dismissible fade show" role="alert" style="margin: 0; border-radius: 0; margin-top: 76px;">
    ...
    <c:if test="${not empty sessionScope.errorMessage}">
        <section class="alert alert-danger alert-dismissible fade show" role="alert" style="margin: 0; border-radius: 0; margin-top: 76px;">
                                    ...
                                    <section class="row align-items-center">
                                        ...
                                        <section class="col-md-4">
                                            ...
                                            <p class="text-muted mb-1 small">
                                                ...
                                                <c:if test="${not empty item.product.color}"> | Màu: ${item.product.color}</c:if>
                                            </p>
                                            <c:if test="${not empty item.product.brand}">
                                                <p class="text-muted mb-0 small">Thương hiệu: ${item.product.brand.name}</p>
                                            </c:if>
                                        </section>
                ...
                <section class="col-lg-4">
                    <aside class="order-summary">
                        ...
                        <section class="summary-row">
                            <span>Tạm tính:</span>
                            <span><fmt:formatNumber value="${cartTotal}" type="number" maxFractionDigits="0"/> đ</span>
                        </section>
                        <section class="summary-row">
                        ...
                        <a href="${pageContext.request.contextPath}/" class="btn btn-outline-secondary w-100 mt-2">
                            <i class="bi bi-arrow-left me-2"></i>Tiếp tục mua sắm
                        </a>                      
                    </aside>
                </section>
